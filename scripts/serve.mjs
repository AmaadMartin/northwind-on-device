 ...
 *
 *   node scripts/serve.mjs [--port 8877]
 */
...
const PORT = Number(portArg !== -1 ? argv[portArg + 1] : process.env.PORT || 8877);
...
server.listen(PORT, () => {
  console.log(`\n  Northwind Hardware   http://localhost:${PORT}/\n`);
});
